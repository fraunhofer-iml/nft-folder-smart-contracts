...
import {ERC721AssetStorage} from "./extensions/ERC721AssetStorage.sol";
import {ERC721Burnable} from "@openzeppelin/contracts/token/ERC721/extensions/ERC721Burnable.sol";
import {ERC721MetadataStorage} from "./extensions/ERC721MetadataStorage.sol";
    ...
    ERC721SegmentAllocation
{
    ...
    function safeMint(
        ...
        _setAsset(tokenId, assetUri, assetHash);
        _setMetadata(tokenId, metadataUri, metadataHash);
    ...
    function _burn(
        uint256 tokenId
    ) internal override(ERC721, ERC721AdditionalInformation, ERC721AssetStorage, ERC721MetadataStorage) {
        super._burn(tokenId);
    }
}
